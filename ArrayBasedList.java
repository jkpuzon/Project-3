...
public class ArrayBasedList<E> implements ListInterface<E> {
	...
	protected int currentBackIteratorPos;       // back iterator position
    ...
    public void resetBackIterator() {
    	currentBackIteratorPos = (list.length - 1);
    }
    ...
    public E getPrevItem() {
	    ...
	    if (currentBackIteratorPos == 0) {
	    	currentBackIteratorPos = numElements;
	    }
	    return prev;
	}
